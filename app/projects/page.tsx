...
const projectsData = [
  ...
  { id: 12, title: "Interactive Kinetic Spider & Wobbly Web", category: "Creative Coding / Canvas API", description: "Built a high-performance interactive experience using Vanilla JavaScript and HTML5 Canvas. Features a real-time 'walking' spider with an 8-leg procedural animation system (Inverse Kinematics) and a physics-based wobbly web that reacts to user clicks with dynamic vibrations.", src: "/projects/spider-web-preview.png", url:"https://spiderwebwalk.netlify.app/"},
];
