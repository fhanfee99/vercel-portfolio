...
const projectsData = [
  ...
  { id: 14, title: "Plasma Fingers: Real-time Electric Hand Effects", category: "Creative Coding / Visual Effects", description: "A visually stunning Python project using OpenCV and MediaPipe that adds dynamic plasma/electric effects to fingertips. Connects all fingers across hands with realistic electric arcs, creating a futuristic interactive experience with live webcam tracking.", src: "/projects/fingereel.png", url: "#" }
];
