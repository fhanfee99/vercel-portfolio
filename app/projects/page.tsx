...
const projectsData = [
  ...
  { id: 4, title: "JobPortal AI: Intelligent Recruitment", category: "Python / Django / OpenAI API", description: "An AI-driven recruitment engine that automates candidate screening. Built with a Django-React architecture, it uses Natural Language Processing (NLP) to rank resumes against job descriptions, providing recruiters with an automated 'Match Score' to streamline hiring.", src: "/projects/jobportalAI.png", url: "#" },
  { id: 5, title: "Secure Candidate Login Portal", category: "Python / Django / JWT Auth", description: "Developed a secure, token-based authentication system using JSON Web Tokens (JWT). Candidates can login via social accounts or credentials, ensuring protected access to dashboards and application tracking.", src: "/projects/candidate_login.png", url: "#" },
  { id: 6, title: "Dynamic Recruiter Signup Workflow", category: "Python / Django / Clerk API", description: "Engineered a multi-step recruiter signup process with immediate role verification. Implemented secure data validation to capture essential company information before unlocking advanced hiring tools.", src: "/projects/recruiter_signup.png", url: "#" },
  ...
  { id: 12, title: "Interactive Kinetic Spider & Wobbly Web", category: "Creative Coding / Canvas API", description: "Built a high-performance interactive experience using Vanilla JavaScript and HTML5 Canvas. Features a real-time 'walking' spider with an 8-leg procedural animation system (Inverse Kinematics) and a physics-based wobbly web that reacts to user clicks with dynamic vibrations.", src: "/projects/spiderweb.png", url:"https://spiderwebwalk.netlify.app/"},
  { id: 13, title: "AirWriterPro: Real-time Air Writing", category: "Creative Coding / Computer Vision", description: "A high-tech interactive project built using Python, OpenCV, and MediaPipe. Enables users to write in air with hand tracking, pinch-to-move strokes, color selection, and real-time glowing ink effects. Supports full-screen webcam drawing with smooth strokes and plasma fingertip effects.", src: "/projects/airwrite.png", url: "#" }, 
  { id: 14, title: "Plasma Fingers: Real-time Electric Hand Effects", category: "Creative Coding / Visual Effects", description: "A visually stunning Python project using OpenCV and MediaPipe that adds dynamic plasma/electric effects to fingertips. Connects all fingers across hands with realistic electric arcs, creating a futuristic interactive experience with live webcam tracking.", src: "/projects/fingureel.png", url: "#" }
];
